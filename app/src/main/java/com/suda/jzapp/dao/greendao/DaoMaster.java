...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        RemarkTipDao.createTable(db, ifNotExists);
        BudgetDao.createTable(db, ifNotExists);
        CurrencyDao.createTable(db, ifNotExists);
        YiYanDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        RemarkTipDao.dropTable(db, ifExists);
        BudgetDao.dropTable(db, ifExists);
        CurrencyDao.dropTable(db, ifExists);
        YiYanDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(RemarkTipDao.class);
        registerDaoClass(BudgetDao.class);
        registerDaoClass(CurrencyDao.class);
        registerDaoClass(YiYanDao.class);
    }
