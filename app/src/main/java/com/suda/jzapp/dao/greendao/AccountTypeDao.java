...
public class AccountTypeDao extends AbstractDao<AccountType, Long> {
    ...
    */
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, AccountType entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AccountType entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(AccountType entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
